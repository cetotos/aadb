...
#if !defined(ADB_DISABLE_COMPRESSION)
...
struct NullEncoder : public Encoder {
...
#else
struct BrotliDecoder final : public NullDecoder {
    using NullDecoder::NullDecoder;
};

struct BrotliEncoder final : public NullEncoder {
    using NullEncoder::NullEncoder;
};

struct LZ4Decoder final : public NullDecoder {
    using NullDecoder::NullDecoder;
};

struct LZ4Encoder final : public NullEncoder {
    using NullEncoder::NullEncoder;
};

struct ZstdDecoder final : public NullDecoder {
    using NullDecoder::NullDecoder;
};

struct ZstdEncoder final : public NullEncoder {
    using NullEncoder::NullEncoder;
};
#endif
