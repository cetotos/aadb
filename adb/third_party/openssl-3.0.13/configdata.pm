...
our %config = (
    ...
    "perlargv" => [
        ...
        "no-tests",
        "-D__ANDROID_API__=30",
        "--prefix=/home/cetotos/Desktop/Proj/adb/build-android/openssl"
    ],
    "perlenv" => {
        "AR" => undef,
        "BUILDFILE" => undef,
...
unless (caller) {
    ...
    use lib '/home/cetotos/Desktop/Proj/adb/third_party/openssl-3.0.13/util/perl';
    use OpenSSL::fallback '/home/cetotos/Desktop/Proj/adb/third_party/openssl-3.0.13/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/cetotos/Desktop/Proj/adb/third_party/openssl-3.0.13/Configurations';
        use gentemplate;
